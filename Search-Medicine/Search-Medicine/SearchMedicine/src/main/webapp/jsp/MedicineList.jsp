...
<%
	...
	<form action="<%=SMView.MEDICINE_LIST_CTL%>" method="post">
		...
		<table class="table table-striped">
			<tr >
				...
				<th scope="col"style="color: blue">Company Name</th>
			...
			<tr>
				...
				<td><a class="btn btn-info"
					href="<%=SMView.MEDICINE_CTL%>?id=<%=bean.getId()%>">Edit</a></td>
				<td><a class="btn btn-danger" href="<%=SMView.MEDICINE_LIST_CTL%>?id=<%=bean.getId()%>">Delete</a></td>
				
				<%}else{%>
				<td><a class="btn btn-success"
					href="<%=SMView.ORDER_MEDICINE_CTL%>?id=<%=bean.getId()%>">Book</a></td>
				<%}%>
			</tr>
